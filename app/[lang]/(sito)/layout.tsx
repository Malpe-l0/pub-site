...
// import { AnteprimaPalette } from '@/components/sito/AnteprimaPalette' // disattivato su richiesta: togliere il commento per riattivarlo
...
export default async function LayoutSito({
  ...
  return (
    // overflow-x-hidden vive sul wrapper interno (non su questo): su iOS Safari
    // un antenato con overflow non-visible disallinea l'area cliccabile di un
    // elemento fixed (l'header sotto) dalla sua posizione visibile durante lo
    // scroll — i bottoni della nav smettono di rispondere al tap.
    <div className="sito-taproom relative flex min-h-screen flex-col">
      ...
      {/* AnteprimaPalette disattivata su richiesta: <AnteprimaPalette /> */}
    </div>
  )
}
